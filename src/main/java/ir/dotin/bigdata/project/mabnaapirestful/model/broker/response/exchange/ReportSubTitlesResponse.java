...
@Getter
@ToString
public class ReportSubTitlesResponse {
    @JsonProperty("data")
    private List<ReportSubTitlesResponse.ReportSubTitlesResponseInner> data;

    @Getter
    @ToString
    public static class ReportSubTitlesResponseInner {
        private String id;
