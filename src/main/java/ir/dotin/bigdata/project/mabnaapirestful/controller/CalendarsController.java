...
public class CalendarsController {
    ...
    private final DatesService datesService;
       public CalendarsController(OccasionTypesService occasionTypesService, CalendarsService calendarsService, DatesService datesService) {
    ...
    @GetMapping("/dates")
    public ResponseEntity<Root<DatesResponse>> getDate() throws JsonProcessingException {
